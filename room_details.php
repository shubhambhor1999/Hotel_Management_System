...
?>
    ...
    <div class="row">
      ...
      <a href="Booking Form.php" class="btn btn-danger">Book Now</a><br><br>
      </div>
	</div>
				<div class="col-sm-3">
    ...
    <!--Fatch Mysql Database Select Query Room Details -->
						<?php
            include('connection.php');
            $sql1=mysqli_query($con,"select * from rooms where room_no=101 OR room_no=201 OR room_no=301 OR room_no=401 OR room_no=501 OR room_no=0");
