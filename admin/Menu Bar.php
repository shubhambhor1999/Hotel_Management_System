...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <img src="../logo/tajlogo.png"/width="70px"height="50px"style="margin-top:5px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="../Booking Form.php"title="#">BookRoom </a></li>
      ...
      {
        ?>
         <li><a href="../food.php"title="#">Book Food </a></li>    
